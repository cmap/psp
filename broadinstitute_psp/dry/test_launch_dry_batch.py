...
import broadinstitute_psp.dry.launch_dry_batch as ldb
...
class TestLaunchDryBatch(unittest.TestCase):
    ...
    def test_get_panorama_request_and_parse(self):
        ...
        ldb.json.loads = mock.Mock(return_value={"id":"fake_id"})

        returned_tuple = ldb.get_panorama_request_and_parse(s3, bucket_name, current_gct_key)
