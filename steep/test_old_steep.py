...
class TestSteep(unittest.TestCase):
    ...
    def test_compute_similarity_matrix(self):
        ...
        # Spearman
        spearman_out = old_steep.compute_similarity_matrix(data_df, method="spearman")
        ...
        pearson_out = old_steep.compute_similarity_matrix(data_df2, method="pearson")
    ...
    def test_create_group_ids(self):
        ...
        (out_group_ids, out_df) = old_steep.create_group_ids(meta_df, "col", group_fields)
        ...
        (out_group_ids2, out_df2) = old_steep.create_group_ids(meta_df2, "row", group_fields2)
    ...
    def test_compute_connectivity(self):
        ...
        e_out_df_unpivoted = pd.DataFrame.from_dict({
            ...
            "target": ["DMSO_MCF7_24", "DMSO_PC3_24", "V_MCF7_24", "V_PC3_24",
                       ...
                       "DMSO_MCF7_24", "DMSO_PC3_24", "V_MCF7_24", "V_PC3_24",
                       "DMSO_MCF7_24", "DMSO_PC3_24", "V_MCF7_24", "V_PC3_24"],
            "ks_statistic": [0.37, 0.35, 0.17, 0.29, 0.30, 0.85, 0.23, 0.41,
                             0.31, 0.24, 0.37, 0.24, 0.32, 0.35, 0.40, 0.33],
            "p_value": [0.75, 0.35, 0.98, 0.60, 0.53, 0.02, 0.81, 0.18,
                        0.47, 0.81, 0.75, 0.81, 0.47, 0.35, 0.21, 0.85],
            "ks_statistic_signed": [0.37, 0.35, 0.17, 0.29, -0.30, 0.85, 0.23, -0.41,
                                    -0.31, 0.24, -0.37, 0.24, 0.32, -0.35, 0.40, 0.33]})
        ...
        (out_df_unpivoted, out_meta_df) = old_steep.compute_connectivity(
    ...
    def test_create_distributions_for_ks_test(self):
        ...
        [queries, targets, tests, nulls, unique_perts] = old_steep.create_distributions_for_ks_test(in_df)
        ...
        [queries2, targets2, tests2, nulls2, unique_perts2] = old_steep.create_distributions_for_ks_test(in_df2)
        ...
        [queries3, targets3, tests3, nulls3, unique_perts3] = old_steep.create_distributions_for_ks_test(in_df3)
        ...
        [queries4, targets4, tests4, nulls4, unique_perts4] = old_steep.create_distributions_for_ks_test(in_df4)
    ...
    def test_assemble_output_conn_gcts(self):
        ...
        (conn_gct, pval_gct, signed_conn_gct) = old_steep.assemble_output_conn_gcts(
    ...
    def test_configure_out_gct_name(self):
        ...
        args_sim_name = None
        out_sim_name = old_steep.configure_out_gct_name(in_gct, sim_suffix, args_sim_name)
        ...
        out_sim_name2 = old_steep.configure_out_gct_name(
